...
describe('All test', function () {
  ...
  describe('SafeUpgradeable', function () {
    it("valid deposit and withdraw", async function () {
      ...
      expect(await coin.balanceOf(wallet1.address)).to.equal(48466);
      expect(await storeFundv2.balances(wallet1.address, coin.address)).to.equal(1533);
      expect(await storeFundv2.totalfee(coin.address)).to.equal(1);
    });
  ...
  describe('SafeUpgradeablev2', function () {
    it("valid deposit and withdraw", async function () {
      ...
      expect(await coin.balanceOf(wallet1.address)).to.equal(48466);
      expect(await storeFundv3.balances(wallet1.address, coin.address)).to.equal(1531);
      expect(await storeFundv3.totalfee(coin.address)).to.equal(3);
    });
  ...
  describe('Original Safe', function () {
    it("valid deposit and withdraw", async function () {
      ...
      expect(await coin.balanceOf(wallet1.address)).to.equal(48466);
      expect(await storeFund.balances(wallet1.address, coin.address)).to.equal(1533);
      expect(await storeFund.totalfee(coin.address)).to.equal(1);
    });
